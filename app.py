...
import collections
from core.ui_common import aggregate, get_base_cap, apply_cap, build_cap_table, apply_presets, filter_by_impact, classify_impact
from core.ui_def import ROLE_JP, CATEGORY_JP, SUB_JP, TAG_JP, EVALUATION_PRESETS
